<template>
  <div id="app">
      ...
      <div class="form"> <!-- <Door number="1" :hasGift="false" /> -->
        <div v-if="!started">
        ...
        <div v-if="!started">
            <label for="selectedPort">Which door will have the prize?</label>
            <input type="text" id="selectedPort" size="3"
                v-model.number="selectedPort">
        </div>
        <button v-if="!started" @click="started = true">Start</button>
        <button v-if="started" @click="started = false">Re-run</button>
      </div>
